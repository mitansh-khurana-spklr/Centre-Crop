...
struct PortraitAspectView: View {
    var uiImage = UIImage(named: "Mitansh Khurana")
    var rectangle : CGRect
    let AR = CGSize(width: 4, height: 5)
    ...
    var body: some View {
        VStack {
            ...
            Text("Image cropped to 4:5 Ratio")
                .font(.title)
...
struct PortraitAspectView_Previews: PreviewProvider {
